...
type Config struct {
	...
	FirstQueue    int   `toml:"first_queue" env:"BS3_FIRST_QUEUE" env-default:"0" env-description:"First queue."`
	QueuesPerNode int   `toml:"queues_per_node" env:"BS3_QUEUES_PER_NODE" env-default:"0" env-description:"Queues per node."`
